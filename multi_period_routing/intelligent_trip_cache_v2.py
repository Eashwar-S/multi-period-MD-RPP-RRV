...
def run_experiment(graph_id: int, 
    ...
    for mode in modes:
        ...
        for repeat in range(n_repeats):
            ...
            ltm = LongTermMemoryBank(max_per_depot=100) if mode == 'intelligent_memory' else None
            ...
            for inst_idx, edge_probs in enumerate(prob_instances):
                ...
                if ltm is not None and inst_idx > 0:
                    selected = ltm.rescore_and_select(inst_idx, edge_probs, top_k=20)
...
if __name__ == '__main__':
    ...
    out_dir    = os.path.join(script_dir, 'memory_results_large')
