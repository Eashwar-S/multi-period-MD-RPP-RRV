...
def neighbour_allocation(allocation: Dict[int, List[Tuple]],
                          mission_times: List[float]) -> Tuple[Dict, Tuple[int, int]]:
    """
    Generate a neighbouring allocation by swap or insert.
    ...
    if random.random() < 0.5:
        # SWAP one edge between two vehicles
        ...
        # INSERT: move one edge from busiest vehicle to another
